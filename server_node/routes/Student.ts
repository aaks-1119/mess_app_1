...
router.get(
  '/verify-student-account/:emailVerificationToken',
  Controller.VerifyStudentAccount,
)
router.get(
  '/check-if-token-exists/:token',
  Controller.CheckIfResetPasswordTokenExists,
)
router.post('/forgot-password', Controller.ForgotPassword)
router.put('/reset-password', CheckJWT, Controller.ResetPassword)
router.get(
  '/check-if-student-verified',
  CheckJWT,
  Controller.CheckIfStudentVerified,
)
